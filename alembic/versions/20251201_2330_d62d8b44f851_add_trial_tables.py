...
def upgrade() -> None:
    ...
    sa.Column('trial_id', sa.UUID(), server_default=sa.text('gen_random_uuid()'), nullable=False),
    ...
    op.create_table('trial_usage',
    sa.Column('usage_id', sa.UUID(), server_default=sa.text('gen_random_uuid()'), nullable=False),
    ...
    op.create_index(op.f('ix_trial_usage_trial_id'), 'trial_usage', ['trial_id'], unique=False)
